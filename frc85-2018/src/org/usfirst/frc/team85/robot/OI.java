...
public class OI {
	...
	private OI() {
		...
		/*
		 * JoystickButton liftSwitchButton = new JoystickButton(_liftOperatorStation,
		 * Addresses.OS_LIFT_SWITCH); JoystickButton liftGroundButton = new
		 * JoystickButton(_liftOperatorStation, Addresses.OS_LIFT_GROUND);
		 * JoystickButton liftPlatformButton = new JoystickButton(_liftOperatorStation,
		 * Addresses.OS_LIFT_PLATFORM); JoystickButton liftLowScaleButton = new
		 * JoystickButton(_liftOperatorStation, Addresses.OS_LIFT_LOW_SCALE);
		 * JoystickButton liftMediumScaleButton = new
		 * JoystickButton(_liftOperatorStation, Addresses.OS_LIFT_MEDIUM_SCALE);
		 * JoystickButton liftHighScaleButton = new JoystickButton(_liftOperatorStation,
		 * Addresses.OS_LIFT_HIGH_SCALE); JoystickButton liftDoubleScaleButton = new
		 * JoystickButton(_liftOperatorStation, Addresses.OS_LIFT_DOUBLE_SCALE);
		 * 
		 * JoystickButton gripperButton = new JoystickButton(_miscOperatorStation,
		 * Addresses.OS_MISC_TOGGLE_GRIPPER); JoystickButton unknownButton = new
		 * JoystickButton(_miscOperatorStation, Addresses.OS_MISC_UNKNOWN);
		 * JoystickButton intakeForwardButton = new JoystickButton(_miscOperatorStation,
		 * Addresses.OS_MISC_INTAKE_FORWARD); JoystickButton intakeReverseButton = new
		 * JoystickButton(_miscOperatorStation, Addresses.OS_MISC_INTAKE_REVERSE);
		 * JoystickButton compressorOnButton = new JoystickButton(_miscOperatorStation,
		 * Addresses.OS_MISC_COMPRESSOR_ON); JoystickButton compressorOffButton = new
		 * JoystickButton(_miscOperatorStation, Addresses.OS_MISC_COMPRESSOR_OFF);
		 * JoystickButton leftChickenWingButton = new
		 * JoystickButton(_miscOperatorStation, Addresses.OS_MISC_LEFT_CHICKEN_WING);
		 * JoystickButton rightChickenWingButton = new
		 * JoystickButton(_miscOperatorStation, Addresses.OS_MISC_RIGHT_CHICKEN_WING);
		 * 
		 ...
		 * unknownButton.whenPressed(new SpinDegrees(-180));
		 */
	}
