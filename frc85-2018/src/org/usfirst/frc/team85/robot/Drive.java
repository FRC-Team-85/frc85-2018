...
public class Drive {
	...
	public static Drive getInstance() {
		if (instance == null) {
			instance = new Drive(Addresses.leftFrontTalon, Addresses.leftBackTalon,
								 Addresses.rightFrontTalon, Addresses.rightBackTalon);
		}
		return instance;
	}
	 ...
	 * @param id1 ID of leftFront Talon
	 * @param id2 ID of leftBack Talon
	 * @param id3 ID of rightFront Talon
	 * @param id4 ID of rightBack Talon
	 */
	 ...
	 * @param speed Desired speed for left motors
	 */
	 ...
	 * @param speed Desired speed for right motors
	 */
